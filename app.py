...
def create_form_with_official_template(buffer, transactions, part_type, taxpayer_name, taxpayer_ssn, tax_year, box_type, page_num, total_pages, all_transactions):
    ...
    try:
        ...
        if part_type == "Part I":
            ...
            checkbox_base_y = 650        # Part I checkbox start at height 105
            table_start_y = 500          # Part I table start at height 200
        else:  # Part II
            # Part II (Page 2) positioning
            name_field_x = 75
            name_field_y = 720            # Page 2 name height
            ssn_field_x = 550
            ssn_field_y = 720             # Page 2 SSN height
            checkbox_base_y = 595        # Part II checkbox start at height 105
